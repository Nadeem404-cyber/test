...
\x1b[1;93m ..##...##.....##.....##
\x1b[1;94m .##.....##....########.
\x1b[1;94m[✓] Contact with server for ip key
\x1b[1;95m[✓] WhatsApp +92 343 5866526
'''
def system():
	CorrectUsername = 'XD'
CorrectPassword = 'Mgfam$G@hacy'
loop = 'true'
while loop == 'true':
    username = raw_input('\x1b[1;97m\xe2\x9e\xa3 Username : ')
    if username == CorrectUsername:
        password = raw_input('\x1b[1;97m\xe2\x9e\xa3 Your AIP Key : ')
...
os.system('xdg-open https://whatsapp me WA.me +92 343 5866526')
# crack selesai
def hasil(ok,cp):
...
def moch_yayan():
    ...
    print ' [%s4%s]. Dump id dari like'%(O,N)
    print ' [%s5%s]. Crack File'%(O,N)
